public class Game {
    ...
    private ShotAttempt takeShot(Team shootingTeam, Team defendingTeam){
        ...
        //System.out.println(shootingPlayer.getName() + " took a shot worth " + shotAttempt.make() + " points.");
        return(shotAttempt);
    }
    ...
    public void shootingTest(CourtLocations courtLocation, double defense){
        Player shooter;
        Player teammate;
        int madeShots;
        int trials = 10000;
